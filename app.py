...
def main():
    ...
    if classifier == 'Logistic Regression':
        ...
        max_iter = st.sidebar.slider('Maximum number of iterations', 100, 5000, key='max_iter')
    ...
    if classifier == 'Random Forest':
        ...
        bootstrap = st.sidebar.radio('Bootstrap samples when building trees',('True', 'False'), key='bootsrap')
